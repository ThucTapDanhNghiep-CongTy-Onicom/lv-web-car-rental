                        ...
                        <form class="custom-validation" action="{{route('location.update',$locations->id)}}" method="POST" enctype="multipart/form-data">
                         @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="locat_name" required="" value="{{$locations->title}}" placeholder="Enter location name">
                                @error('locat_name')
                            ...
                            <div class="form-group">
                                ...
                                <img src="<?= $locations->photo ?>" alt="" style="width: 100px;
    height: 100px;
    margin: 10px auto;">
