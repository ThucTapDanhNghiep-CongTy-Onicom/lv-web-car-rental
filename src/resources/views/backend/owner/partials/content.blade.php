                ...
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Tổng hóa đơn</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Hóa đơn đã thanh toán</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Hóa đơn chưa thanh toán</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Tổng số hóa đơn đã gửi</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="row  mt-xl-0 mt-4">
                                    <div class="col-md-6">
                                        <h4 class="card-title">Tổng quan về thẻ</h4>
                                        <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit psu olor</span>
                                        <ul class="card-list mt-4">
                                            <li><span class="bg-blue circle"></span>Tài khoản<span>20%</span></li>
                                            <li><span class="bg-success circle"></span>Dịch vụ<span>40%</span></li>
                                            <li><span class="bg-warning circle"></span>Quán ăn<span>15%</span></li>
                                            <li><span class="bg-light circle"></span>Khác<span>15%</span></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
            ...
            <div class="col-xl-3 col-xxl-5">
                <div class="card">
                    <div class="card-header pb-0 border-0">
                        <div>
                            <h4 class="card-title mb-2">Hoạt động</h4>
                            <h2 class="mb-0">$78120</h2>
                        </div>
                        <ul class="card-list">
                            <li class="justify-content-end">Thu<span class="bg-success circle me-0 ms-2"></span></li>
                            <li class="justify-content-end">Nhận<span class="bg-danger circle me-0 ms-2"></span></li>
                        </ul>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-7">
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <div>
                            <h4 class="card-title mb-2">Chuyển Khoản Nhanh</h4>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="javascript:void(0);">Cập nhập</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">	
                    ...
                    <div class="card-footer border-0 pt-0">
                        <a href="javascript:void(0);" class="btn btn-primary d-block btn-lg text-uppercase">Giao dịch trước đó</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-xxl-5">
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <div>
                            <h4 class="card-title mb-2">Chỉ tiêu</h4>
                            <span class="fs-12">Lorem ipsum dolor sit amet, consectetur</span>
                        </div>
                        <div class="dropdown">
                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="card-footer border-0 pt-0">
                        <a href="javascript:void(0);" class="btn btn-outline-primary d-block btn-lg">Xem thêm</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-flex flex-wrap border-0 pb-0">
                        <div class="me-auto mb-sm-0 mb-3">
                            <h4 class="card-title mb-2">Tổng Quan Về Giao Dịch</h4>
                            <span class="fs-12">Lorem ipsum dolor sit amet, consectetur</span>
                        </div>
                    ...
                    <div class="card-body pb-2">
                        <div class="d-sm-flex d-block">
                            <div class="form-check toggle-switch text-end form-switch me-4">
                              ...
                              <label class="form-check-label" for="flexSwitchCheckDefault">Số</label>
                            </div>
                            <div class="form-check toggle-switch text-end form-switch me-auto">
                              ...
                              <label class="form-check-label" for="flexSwitchCheckDefault1">Phân tích</label>
                            </div>
                            <ul class="card-list d-flex mt-sm-0 mt-3">
                                <li class="me-3"><span class="bg-success circle"></span>Thu</li>
                                <li><span class="bg-danger circle"></span>Nhận</li>
                            </ul>
                        </div>
            ...
            <div class="col-xl-6 col-xxl-12">
                <div class="card">
                    <div class="card-header d-block d-sm-flex border-0">
                        <div class="me-3">
                            <h4 class="card-title mb-2">Giao Dịch Trước Đó</h4>
                            <span class="fs-12">Lorem ipsum dolor sit amet, consectetur</span>
                        </div>
                        <div class="card-tabs mt-3 mt-sm-0">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#monthly" role="tab">Hàng tháng</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#Weekly" role="tab">Hàng tuần</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#Today" role="tab">Hôm nay</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card coin-card">
                            <div class="card-body d-sm-flex d-block align-items-center">
                                ...
                                <div>
                                    <h3 class="text-white">Được quản lý bởi Trợ lý ảo của Dompet</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim </p>
                                    <a class="text-white" href="javascript:void(0);">Tìm hiểm thêm >></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card progress-card">
                            <div class="card-body d-flex">
                                <div class="me-auto">
                                    <h4 class="card-title">Tổng Số Giao Dịch</h4>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Hóa Đơn Còn Lại</h4>
                                <div class="d-flex align-items-center">
                                    <div class="me-auto">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mt-2">Hóa Đơn Đã Gửi</h4>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mt-2">Hóa Đơn Đã Được Lập</h4>
                                <div class="d-flex align-items-center mt-3 mb-2">
